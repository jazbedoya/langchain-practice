...
def crear_evaluador_cv():
    ...
    modelo_estructurado = modelo_base.with_structured_output(AnalisisCV) #AnalisisCV de pydantic
...
def evaluar_candidato(texto_cv : str, descripcion_puesto : str) -> AnalisisCV:
    try:
        ...
        return AnalisisCV(
            ...
            experiencia_años=0,
            habilidades_clave=["Error al procesar"],
            educacion="No se puede determinar",
            experiencia_relevante="Eror durante el analisis",
            fortalezas=["Requiere revision manuela"],
            areas_mejora=["Verificar formato"],
