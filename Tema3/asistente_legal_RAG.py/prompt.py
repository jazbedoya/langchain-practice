...
Tu tarea es generar múltiples versiones de la consulta del usuario para recuperar documentos relevantes.
...
RELEVANCE_PROMPT = """
Analiza si el siguiente fragmento de documento es relevante para responder la consulta.
...
Responde solo con "SÍ" o "NO" y una breve explicación.
"""

# Prompt para extracción de entidades clave

ENTITY_EXTRACTION_PROMPT = """
Extrae las entidades clave del siguiente texto de contrato de arrendamiento.
